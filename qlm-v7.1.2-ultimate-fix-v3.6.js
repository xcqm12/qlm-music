 ...
 * @version 7.1.2-ultimate-fix-v3.6
...
(function() {
    ...
    const ANNOUNCEMENT = Object.freeze({
        title: "七零喵聚合音源 v7.1.2-ultimate-fix-v3.6",
    ...
    async function initialize() {
        ...
        console.log('[聚合音源 v7.1.2-ultimate-fix-v3.6] 初始化 (qorg 三重回退)');
        startStatsCleanup();
        setupEventListener();
