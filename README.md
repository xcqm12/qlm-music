...
| **qlm-v1.0.0** | ✅ 可用 | 重构版 1.0.0，基于 v7.0.7 架构重构，整合 v9.0.9 全部 28+ 音源，修复初始化失败、not a function 错误、缺失音源函数等问题 | 历史版本兼容 |
