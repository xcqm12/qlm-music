...
https://img.shields.io/badge/version-7.0.7-blue.svg
...
https://raw.githubusercontent.com/xcqm12/qlm-music/main/qlm-v7.0.7.js

# 备用链接（CDN）
https://cdn.jsdelivr.net/gh/xcqm12/qlm-music/qlm-v7.0.7.js
```

方式二：本地文件导入

1. 下载本仓库的以下任一版本文件：
   · qlm-v7.0.7.js（最新完整版，推荐）
   · qlm-fix-v7.0.2.js（修复优化版，稳定）
   · qlm-v7.0.1.js（完整整合版，稳定）
...
版本 说明 推荐场景
v7.0.7 最新完整版，修复 updateAlert 重复调用问题 强烈推荐
v7.0.6 完整整合版，新增自建网易云音源 稳定版本
v7.0.5 新增自建网易云音源 尝鲜版本
v7.0.4 优化网易云盘 Cookie 管理 需要使用云盘功能
v7.0.2 修复优化版，优化请求逻辑，新增公告系统 稳定备选
v7.0.1 完整整合版，修复 musicUrl 支持 稳定备选
...
文件名 版本 说明 下载
qlm-v7.0.7.js v7.0.7 最新完整版 下载
qlm-v7.0.6.js v7.0.6 完整整合版 下载
qlm-v7.0.5.js v7.0.5 尝鲜版 下载
qlm-v7.0.4.js v7.0.4 云盘优化版 下载
qlm-fix-v7.0.2.js v7.0.2 修复优化版 下载
qlm-v7.0.1.js v7.0.1 稳定备选版 下载