 ...
 * @version 7.1.2-ultimate-fix-v3.6-fixed-patch1
...
(function() {
    ...
    const ANNOUNCEMENT = Object.freeze({
        title: "七零喵聚合音源 v7.1.2-ultimate-fix-v3.6-fixed-patch1",
    ...
    async function juheGetMusicUrl(source, info) {
        ...
        try {
            ...
            if (body.code === 200) {
                const url = extractUrl(SafeUtils.safeGet(body, 'data.url') || body.url, 'juhe');
    ...
    async function initialize() {
        ...
        console.log('[聚合音源 v7.1.2-ultimate-fix-v3.6-fixed-patch1] 初始化 (qorg 三重回退)');
        startStatsCleanup();
        setupEventListener();
