...
(function() {
    ...
    // ==================== 防冲突标识 ====================
    const SCRIPT_ID = 'qlm_music_source_v7_0_5_' + Date.now();
    ...
    const CONFIG = {
        ...
        // 网易云盘配置
        NETEASE_CLOUD_COOKIE_KEY: 'qlm_netease_cloud_cookie',
    ...
    async function autoGetWycloudCookie() {
        ...
        console.log('[网易云盘] 请手动设置网易云音乐Cookie');
        
        try {
            if (typeof send === 'function') {
                send(EVENT_NAMES.updateAlert, {
                    log: '网易云盘需要设置Cookie才能使用\n请在设置中配置网易云音乐Cookie',
                    updateUrl: null
                });
            }
        } catch (e) {}
    ...
    async function initialize() {
        ...
        console.log('[聚合音源·超级整合版（完整版）+ 自建网易云] v7.0.5 初始化中...');
        ...
        console.log('[聚合音源·超级整合版（完整版）+ 自建网易云] v7.0.5 已加载');
